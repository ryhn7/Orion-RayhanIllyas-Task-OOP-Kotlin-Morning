...
class Hero {
    ...
    /**
     * Buat fungsi untuk lari, makan, minum, lompat, dan duduk. Masing2 memiliki kriteria sebagai
     * berikut:
     ...
     * - ubah nilai variable health sesuai kegiatan yang dilakukan: lari = -2 makan = +2 minum = +2
     * lompat = -2 duduk = +1
     *
